...
{
    public partial class PlayerLayoutControl : UserControl
    {
        ...
        public PlayerLayoutControl()
        {
            InitializeComponent();
            Loaded += PlayerLayoutLoaded;
        }

        private void PlayerLayoutLoaded(object sender, RoutedEventArgs e)
        {
            Loaded -= PlayerLayoutLoaded;
            InitializeSpotList();
        }
